...
export const getUserOrders = () => async (dispatch, getState) => {
  ...
  try {
    ...
    dispatch({ type: "GET_USER_ORDERS_FAILED", payload: error.message }); // Dispatch error message
  }
};
...
export const getAllOrders = () => async (dispatch) => {
  ...
  try {
    ...
    console.error("Error fetching pizzas:", error); // Log the error
    dispatch({ type: "GET_ALLORDERS_FAILED", payload: error.message }); // Dispatch error message
  }
};
